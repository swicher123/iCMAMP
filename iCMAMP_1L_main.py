...
def read_feature(dataset,i):
        ...
        # 重新初始化字典
        df_pos_features = {1: 'AAC_pos', 2: '2DMD_pos', 3: 'DPC_pos', 4: 'NTCT5_pos', 5: 'ESM1b_pos',
                           6: 'Fingerprint_pos', 7: 'ATC_pos'}
        df_neg_features = {1: 'AAC_neg', 2: '2DMD_neg', 3: 'DPC_neg', 4: 'NTCT5_neg', 5: 'ESM1b_neg',
                           6: 'Fingerprint_neg', 7: 'ATC_neg'}
